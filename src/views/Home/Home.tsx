...
import {LinkExternal, Button, Heading, Text, BaseLayout } from 'avax-antswaptoken-uikit'
...
const Home: React.FC = () => {
  ...
  return (
    <Page>
      <Hero>
          <img src="/images/banner.png" alt="antswap avalanche banner" width={980} height={75} />
