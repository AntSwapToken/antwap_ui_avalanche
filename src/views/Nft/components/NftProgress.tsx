...
import { Card, CardBody, Heading, OpenNewIcon, Text, Link as UIKitLink, Progress } from 'avax-antswaptoken-uikit'
        ...
        <InfoRow>
          ...
          <div>
            {!isInitialized ? (
              ...
              <Link href={`https://app.pangolin.exchange/block/${endBlockNumber}`} target="_blank" rel="noreferrer noopener">
